...
This particular code creates every unique model of size three vertices or less; however, changing the function input to extend the number of vertices is easy. A database with findings is attached.
